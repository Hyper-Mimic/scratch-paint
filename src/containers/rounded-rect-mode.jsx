...
class RoundedRectMode extends React.Component {
    ...
    componentWillReceiveProps (nextProps) {
        ...
        if (this.tool && nextProps.roundedRectRadii !== this.props.roundedRectRadii) {
            this.tool.setCornerRadii(nextProps.roundedRectRadii);
        }
    ...
    activateTool () {
        ...
        if (this.props.roundedRectRadii) {
            this.tool.setCornerRadii(this.props.roundedRectRadii);
        }
        this.tool.activate();
    }
    validateColorState () {
...
RoundedRectMode.propTypes = {
    ...
    roundedRectRadii: PropTypes.arrayOf(PropTypes.number),
